program define ldea
* By starting this file with the defintion of a small dummy ADO file, 
* we enable the user to load the Mata library functions from this ado file
* which Stata can locate anywhere in the adopath.  
* 
* This avoids the need to keep the ldea.do file in the working directory
* and enables it to be loaded automatically into Stata by a profile.do file

  di _n(2) "****  Intitialize Stata for running dea.ado  ****"  _n(2)
